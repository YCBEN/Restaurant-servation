                ...
                <form method="POST" action="{{ route('admin.categories.update',$category->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <label class=" mb-2  text-sm font-medium text-gray-900 "
                            ...
                            <img src="{{ asset("categories/".$category->image) }}" class="m-2" style="width:10%"/>
...
<textarea name="description" id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here...">{{ $category->description }}</textarea>
