<x-admin-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.menus.update',$menu->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="title" value="{{ $menu->name }}" name="title"
                    ...
                    <div class="mb-6">
                      ...
                      <input type="number" id="price" value="{{ $menu->price }}" name="price"
                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="mb-6">
                        ...
                        <label class=" mb-2  text-sm font-medium text-gray-900 "
                            ...
                            <img src="{{ asset("menus/".$menu->image) }}" class="m-2" style="width:10%"/>
                            <input name="image" id="image" value="{{ $menu->image }}" type="file" class="block w-full text-lg text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" >
  ...
  <textarea name="description" id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here...">{{ $menu->description }}</textarea>
